...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="card bg-dark text-white " style="box-shadow: 5px 5px 5px black;">
      <div id="pos" class="card-header">
        Postagem Nº 44
        
      </div>
      <div class="card-body">
        <h4 id="Subtítulo do cartão" class="card-title">titulo</h4>
        <br>
        <h6 class="card-subtitle">Subtítulo do cartão</h6>
        <br>
        <p id="Subtítulo do cartão" class="card-text">texto</p>
       <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModal" >Remover </button>
      </div>
    </div>
    <!-- fim cartao -->
